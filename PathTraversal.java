...
//            var id = request.getParameter("id");
            ...
            try {
                String canonicalPath = Paths.get(id).normalize().toString();
                if (!canonicalPath.startsWith("/expected/base/directory")) { // Replace with your base directory
                    throw new SecurityException("Invalid file path");
                }
                (new File(canonicalPath)).exists();
